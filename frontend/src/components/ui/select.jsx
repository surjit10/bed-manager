...
const SelectTrigger = React.forwardRef(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      "dark:border-input dark:bg-card dark:text-card-foreground dark:shadow-black/20",
      className
    )}
    {...props}>
    {children}
...
const SelectContent = React.forwardRef(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Content
    ...
    className={cn(
      ...
      "dark:border-input dark:bg-card dark:text-card-foreground dark:shadow-black/40",
      position === "popper" &&
...
const SelectLabel = React.forwardRef(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn("py-1.5 pe-2 ps-8 text-xs font-medium text-muted-foreground dark:text-muted-foreground", className)}
    {...props} />
));
